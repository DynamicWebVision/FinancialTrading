...
use App\ForexBackTest\BackTestToBeProcessed\ForexStrategy\BollingerPb\BollingerPbBackTestToBeProcessed;
...
class AutomatedBackTestController extends Controller {
    ...
    public function environmentVariableDriveProcess($processId = false) {
        ...
        elseif ($this->server->current_back_test_strategy == 'AMAZING_CROSSOVER') {
            $backTestStrategy = new AmazingCrossoverBackTestToBeProcessed($processId, $this->server, $this->logger);
        ...
        elseif ($this->server->current_back_test_strategy == 'BOLL_PB') {
            $backTestStrategy = new BollingerPbBackTestToBeProcessed($processId, $this->server, $this->logger);
            $backTestStrategy->callProcess();
        }
        //END OF STRATEGY IFS
        $backTestStrategy->callProcess();
