<?php namespace App\BackTest\BackTestToBeProcessed\Strategy\TwoTier\ThreeMaSystem;
...
use App\Strategy\TwoTier\ThreeMa\SimpleMaNoOtherConfirm;
use App\Strategy\TwoTier\ThreeMa\ExponentialMaNoOtherConfirm;
use App\Strategy\TwoTier\ThreeMa\HullMaNoOtherConfirm;

use \App\BackTest\StopLossOrStrategyClose;

use \Log;

class StayIn extends \App\BackTest\BackTestToBeProcessed\Base
{
