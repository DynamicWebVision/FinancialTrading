<?php namespace App\BackTest\BackTestToBeProcessed\Strategy\Bollinger;
...
use \App\Strategy\Bollinger\AdxBelowBollinger;

use \Log;

class BollingerSlTp extends \App\BackTest\BackTestToBeProcessed\Base
{
