<?php namespace App\ForexBackTest\BackTestToBeProcessed\ForexStrategy\TwoTier\PivotPoint;
...
use \App\ForexStrategy\TwoTier\PivotPoints\HmaMomentumConfirm;

use \Log;

class PivotPointTestTPSl extends \App\ForexBackTest\BackTestToBeProcessed\Base
{
