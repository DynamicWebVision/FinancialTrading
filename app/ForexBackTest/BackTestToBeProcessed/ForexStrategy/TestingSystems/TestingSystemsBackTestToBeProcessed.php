<?php namespace App\ForexBackTest\BackTestToBeProcessed\ForexStrategy\TestingSystems;

/**********************
TestingSystems Backtest Variable Definitions
...
use \App\ForexStrategy\TestingSystems\HmaPricePointTest;
//END STRATEGY DECLARATIONS

class TestingSystemsBackTestToBeProcessed extends \App\ForexBackTest\BackTestToBeProcessed\Base
{
    ...
    public function callProcess() {
        ...
        ******************************/
        ...
        elseif ($this->server->strategy_iteration == 'HMA_PRICE_TAERGET_TEST') {
            $backTest->rateLevel = 'both';
        
            $strategy = new HmaPricePointTest(1,1,true);
