<?php namespace App\ForexBackTest\BackTestToBeProcessed\ForexStrategy\RsiPullback;
...
class RsiPullbackBackTestToBeProcessed extends \App\ForexBackTest\BackTestToBeProcessed\Base
{
    ...
    public function callProcess() {
        ...
        ******************************/
        ...
        elseif ($this->server->strategy_iteration == 'RSI_PB_HMA_SL_BE') {
            $backTest->rateLevel = 'both';
        
            $strategy = new RsiPbHmaSLBe(1,1,true);
            ...
            $strategy->hmaLength = intval($this->backTestToBeProcessed->variable_3);
        ...
        elseif ($this->server->strategy_iteration == 'RSI_PB_EMA_PROF') {
            $backTest->rateLevel = 'both';
        
            $strategy = new RsiPbEmaProf(1,1,true);
