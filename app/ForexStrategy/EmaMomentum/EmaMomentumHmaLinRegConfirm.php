...
class EmaMomentumHmaLinRegConfirm extends \App\ForexStrategy\Strategy  {
    ...
    public function checkForNewPosition($rates) {
        ...
        //Hma Long Confirm
        $this->decisionIndicators['hmaSlow'] = $this->indicators->hma($this->ratesPips, $this->hmaSlowLength);

        $this->decisionIndicators['hmaSlowLinReg'] = $this->indicators->linearRegression($this->decisionIndicators['hmaSlow'], $this->hmaLinRegLength);
