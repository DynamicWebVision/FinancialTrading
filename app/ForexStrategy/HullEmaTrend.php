...
class HullEmaTrend extends \App\ForexStrategy\Strategy  {
...
//        }
    ...
    public function checkForNewPosition($rates) {
        ...
        $this->decisionIndicators['hma'] = $this->indicators->ema($rates, $this->hullLength);
        ...
        $this->hullLongLength = 50;
        $this->ratesPips = $this->getRatesInPips($this->rates);

       // $this->decisionIndicators['hmaLongPipRates'] = $this->indicators->ema($this->ratesPips, $this->hullLongLength);

       // $this->decisionIndicators['hmaLongLinRegPipRates'] = $this->indicators->linearRegression($this->decisionIndicators['hmaLongPipRates'], 3);
