...
class SlowHmaStochFastHmaCross extends \App\ForexStrategy\Strategy  {
    ...
    public function checkForNewPosition() {
        ...
        //Stoch Overbought
        $this->decisionIndicators['slowStochOverboughtCheck'] = $stochasticEvents->overBoughtCheck($this->slowRates['full'], $this->slowRatesKLength, $this->slowRatesSmoothingSlow, $this->slowRatesSmoothingFull, $this->slowRatesStochOverboughtCutoff);

        //Hma Crossover for Fast Rates
        $this->decisionIndicators['fastHmaCrossover'] = $momentum->hmaCrossover($this->rates, $this->fastFastHmaLength, $this->fastSlowHmaLength);
