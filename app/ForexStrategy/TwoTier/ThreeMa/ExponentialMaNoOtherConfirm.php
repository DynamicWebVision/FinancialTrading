...
class ExponentialMaNoOtherConfirm extends \App\ForexStrategy\Strategy  {
    ...
    public function checkForNewPosition() {
        ...
        $this->decisionIndicators['slowThreeLine'] = $momentumEvents->threeMAExponential($this->fastMaLength, $this->mediumMaLength, $this->slowMaLength, $this->slowRates);

        $this->decisionIndicators['fastThreeLine'] = $momentumEvents->threeMAExponential($this->fastMaLength, $this->mediumMaLength, $this->slowMaLength, $this->rates);
