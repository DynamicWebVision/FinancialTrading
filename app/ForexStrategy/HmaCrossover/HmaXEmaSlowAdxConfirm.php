...
class HmaXEmaSlowAdxConfirm extends \App\ForexStrategy\Strategy  {
    ...
    public function checkForNewPosition() {
        ...
        $this->decisionIndicators['slowEma'] = $this->indicators->ema($this->rates['simple'], $this->emaSlowLength);

        $this->decisionIndicators['adx'] = $this->indicators->adx($this->rates['full'], $this->adxPeriodLength);

        $this->decisionIndicators['hmaCrossover'] = $this->indicators->checkCrossoverGoBackTwo($this->decisionIndicators['fastHma'], $this->decisionIndicators['slowEma']);
